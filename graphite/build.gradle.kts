...
description = "Graphite demo. Show how to do save & poll"
...
task<JavaExec>("runCampaignForSaveAndPoll") {
    group = "application"
    description = "Start a campaign with the scenario graphite-save-and-poll"
    mainClass.set("io.qalipsis.runtime.Qalipsis")
    maxHeapSize = "256m"
    args("--autostart", "-c", "report.export.console.enabled=true", "-s", "graphite-save-and-poll")
