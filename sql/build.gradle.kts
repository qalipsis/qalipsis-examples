...
description = "SQL demo. Show how to do save & poll and save & search"
...
tasks {
    create("runCampaignForSaveAndPoll", RunQalipsis::class.java) {
        scenarios("sql-save-and-poll")
    }

    create("runCampaignForSaveAndSearch", RunQalipsis::class.java) {
        scenarios("sql-save-and-search")
    }

    withType<RunQalipsis> {
        configuration(
            "report.export.console.enabled" to "false",
