...
description = "Redis demo. Show how to do save & poll and produce & consume"
...
tasks {
    create("runCampaignForSaveAndPoll", RunQalipsis::class.java) {
        scenarios("redis-save-and-poll")
    }

    create("runCampaignForProduceAndConsume", RunQalipsis::class.java) {
        scenarios("redis-produce-and-consume")
    }
    ...
    named("check") {
        dependsOn("runCampaignForSaveAndPoll", "runCampaignForProduceAndConsume")
    }
}
